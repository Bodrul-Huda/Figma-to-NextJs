        ...
        <div className="py-20 radius-for-skewed overflow-hidden">
          <div className="max-w-6xl px-4 pb-6 lg:pb-16">
            <div className="flex flex-wrap justify-center lg:justify-center ">
              <div className="w-full lg:w-4/5 mb-4 lg:mb-0">
                <h2 className=" text-button1 uppercase py-4">
                  Testimonial List
                </h2>
          ...
          <div className="relative flex">
            <div className="flex flex-wrap max-w-6xl px-2 mx-auto">
              <div className="my-4 w-full lg:w-1/3 px-3">
                <div className="p-8 bg-white rounded shadow text-center">
                  <img
                    className="mb-2 mx-auto w-16 h-16 rounded-md object-cover"
                    src="/testimonial/Rectangle 2097.png"
                    alt=""
                  />
              ...
              <div className="my-4 w-full lg:w-1/3 px-3">
                <div className="p-8 bg-white rounded shadow text-center">
                  <img
                    className="mb-2 mx-auto w-16 h-16 rounded-md object-cover"
                    src="/testimonial/Rectangle 2097(1).png"
                    alt=""
                  />
                  <p className="mb-8 text-gray-300 text-sm ">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              ...
              <div className="my-4 w-full lg:w-1/3 px-3">
                <div className="p-8 bg-white rounded shadow text-center">
                  <img
                    className="mb-2 mx-auto w-16 h-16 rounded-md object-cover"
                    src="/testimonial/Rectangle 2097(2).png"
                    alt=""
                  />
                  <p className="mb-8 text-gray-300 text-sm ">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              ...
              <div className="my-4 w-full lg:w-1/3 px-3">
                <div className="p-8 bg-white rounded shadow text-center">
                  <img
                    className="mb-2 mx-auto w-16 h-16 rounded-md object-cover"
                    src="/testimonial/Rectangle 2097(3).png"
                    alt=""
                  />
                  <p className="mb-8 text-gray-300 text-sm ">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              ...
              <div className="my-4 w-full lg:w-1/3 px-3">
                <div className="p-8 bg-white rounded shadow text-center">
                  <img
                    className="mb-2 mx-auto w-16 h-16 rounded-md object-cover"
                    src="/testimonial/Rectangle 2097(4).png"
                    alt=""
                  />
                  <p className="mb-8 text-gray-300 text-sm ">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              ...
              <div className="my-4 w-full lg:w-1/3 px-3">
                <div className="p-8 bg-white rounded shadow text-center">
                  <img
                    className="mb-2 mx-auto w-16 h-16 rounded-md object-cover"
                    src="/testimonial/Rectangle 2097(5).png"
                    alt=""
                  />
                  <p className="mb-8 text-gray-300 text-sm ">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
